...
def get_target_stock_list(conn, type):
    ...
    kospi = target_df[(gubun == 'KOSPI') & (market_cap> 1000000000000) & (ratio > 0)].sort_values(by='value_cap_ratio', ascending=False).iloc[0:10]
    kosdaq = target_df[(gubun == 'KOSDAQ') | gubun ==  & (market_cap> 100000000000) & (market_cap < 500000000000) & (ratio > 0)].sort_values(by='value_cap_ratio', ascending=False).iloc[0:10]
